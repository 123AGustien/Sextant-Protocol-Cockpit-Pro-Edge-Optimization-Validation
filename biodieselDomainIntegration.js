...
(function (global) {
    ...
    if (
        typeof global.biodieselTrialResult ===
        "undefined"
    ) {
        global.biodieselTrialResult = null;
    }
    ...
    function runBiodieselTrialManoeuvre(
        ...
        /*
         * Explicit integration-level handoff.
         *
         * Trial module also stores this result, but the domain
         * integration layer retains the reference as the
         * authoritative current trial result for validation.
         */
    ...
    function validateBiodieselTrialManoeuvre(
        ...
        /*
         * Use the explicitly supplied result when available.
         * Otherwise use the most recent trial result retained
         * by the Biodiesel integration layer.
         */
    ...
    /* ========================================================
       LEGACY / COCKPIT COMPATIBILITY ALIAS
       ======================================================== */

    /*
     * Preserve the authoritative integration object while
     * providing compatibility for cockpit/UI code that still
     * references the earlier BiodieselIntegration name.
     */

    global.BiodieselIntegration =
        global.BiodieselDomainIntegration;
